#
# Be sure to run `pod lib lint MyFirstPodTestLibrary.podspec' to ensure this is a
...
My testing for pod spec library. for testing purpose only.
  ...
  s.source_files = 'MyFirstPodTestLibrary/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MyFirstPodTestLibrary' => ['MyFirstPodTestLibrary/Assets/*.png']
  # }
